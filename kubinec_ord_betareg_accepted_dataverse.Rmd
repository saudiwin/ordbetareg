...
Replication code for this article is available at @kubinec2022 at <https://doi.org/10.7910/DVN/5XYO7O>. For a reproducible version of this paper, please see the Github repository <https://github.com/saudiwin/ordbetareg>. The R package `ordbetareg`, available on CRAN, includes a full range of model specifications for ordered beta regression, including multilevel/hierarchical models.
